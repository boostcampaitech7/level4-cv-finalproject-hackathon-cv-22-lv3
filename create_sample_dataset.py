...
# def create_sample_dataset(input_csv, output_csv, sample_size=0.1, random_state=42):
#     """
...
#         sample_size (float): 샘플 데이터 비율 (기본값: 0.1)
...
#     parser.add_argument("--sample_size", type=float, default=0.1, help="샘플 데이터 비율 (기본값: 0.1)")
