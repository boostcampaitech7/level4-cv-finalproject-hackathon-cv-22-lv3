...
from inform.interface.controllers.inform_controller import router as inform_routers
...
app.include_router(inform_routers)
...
if __name__ == "__main__":
    uvicorn.run("main:app", host="127.0.0.1", reload=True, log_config=None)