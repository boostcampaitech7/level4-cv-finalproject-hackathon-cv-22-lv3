...
from user_input.optimization_setting import base_optimize_setting
...
def main_pipline():
    ...
    direction, n_trials, target_class = base_optimize_setting(merged_file_path, task)

    # 최적화를 진행한다.
    comparison_df, original_prediction, optimized_prediction_value = feature_optimize(
        data_frame, task, target_feature, direction, n_trials, target_class, test_df,
